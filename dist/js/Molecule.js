...
function Molecule(graph,options){
    ...
    this.maxNodeId = d3.max(graph.nodes,function(d){return d.id});
...
Molecule.prototype.addNode = function (atom,size) {
    this.maxNodeId += 1;
    this.graph.nodes.push({"id": this.maxNodeId,"atom":atom,"size":size});
...
Molecule.prototype.addLink = function (source_id,target_id,bond) {
    ...
    var link_object = {"source": source_index, "target": target_index, "bond": bond};
